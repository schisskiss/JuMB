...
public class TelList extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tellist_layout);
		
		listView = (ListView) findViewById(R.id.tellist);
    ...
    private void clickOnUser(int position){
        Intent intent = new Intent(this, onClickUser.class);
        Bundle b = new Bundle();
    ...
    public class MyAsyncTask extends AsyncTask<String, Integer, Double>{
		...
		public void postData() {
			...
			HttpPost httppost = new HttpPost("http://schisskiss.no-ip.biz/jumb/alluser.php");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menuItemTelList.setEnabled(false).setVisible(true);
        menuItemAddEntry.setEnabled(true).setVisible(true);
        menuItemAddUser.setEnabled(true).setVisible(true);
